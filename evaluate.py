...
# Path configurations
label_map_path = "lab6/models-master/ssd_mobilenet_v2/train/label_map.pbtxt"
val_record_path = "lab6/models-master/ssd_mobilenet_v2/train/val.record"
model_dir = "lab6/exported_model_v12/saved_model"
...
num_classes = len(category_index)  # นับจำนวนคลาสทั้งหมด
true_labels_bin = label_binarize(true_labels, classes=list(range(num_classes + 1)))  # +1 เผื่อ no detection
predicted_scores_bin = label_binarize(predicted_labels, classes=list(range(num_classes + 1)))

map_score = average_precision_score(true_labels_bin, predicted_scores_bin, average='macro')
